...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    ...
    <div class="h1">
        <h1>KabaddiTeam Registration</h1></div>
<form action="KabaddiReg.php" method="post">
<p align="center">
BRANCH:-
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        for ($i=0; $i <12 ; $i++) 
        { 
            $s="insert into kabaddi(PEN,Name,ContactNumber,Branch,Year) value ('".$_POST['PEN'][$i]."','".$_POST['Name'][$i]."','".$_POST['ContactNumber'][$i]."', '$Branch','$Year')";
