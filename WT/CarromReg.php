...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    ...
    <div class="h1">
        <h1>Carrom Team Registration</h1></div>
<form action="CarromReg.php" method="post">
<p align="center">
BRANCH:-
     ...
     <div style="margin-left: 200px; width: 70%;">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td><input type="text" name="PEN[]" required="" placeholder="Enter PEN"></td>
                <td><input type="text" name="Name[]" required="" placeholder="Enter your Name"></td>
                <td><input type="text"  name="ContactNumber[]" required="" placeholder="Player Contact No."></td>
            </tr>
            </tbody>
        </table>
    </div>
...
for ($i=0; $i <2 ; $i++) 
{ 
$s="insert into carrom(PEN,Name,ContactNumber,Branch,Year) value ('".$_POST['PEN'][$i]."','".$_POST['Name'][$i]."','".$_POST['ContactNumber'][$i]."', '$Branch','$Year')";
