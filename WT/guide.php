...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    ...
    <div class="h1">
        <h1>How to Use</h1> </div>
    
    <ol>
        <li>This is the Home page of our website,you can easily identify services mention in the below image like Registers,Schedules,News,etc. You have to click any one like we select Registers and other services is same as Registers just go and check </li>
        <p><img src="file/img/guide/1.JPG" alt=""></p><br>
        <li>After click on Registers,you see the activities mention in the given below image, you have to choose whatever activities you need to register.</li>
        <p><img src="file/img/guide/2.JPG" alt=""></p><br>
        <li>Please contact if any problem/suggetion.</li>
        <p><img src="file/img/guide/4.JPG" alt=""></p><br>
        <li>please subscribe if you liked our website</li>
        <p><img src="file/img/guide/3.JPG" alt=""></p><br>
    </ol>
<!------- Footer ------->
  <footer id="footer">
