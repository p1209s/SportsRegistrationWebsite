...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    ...
    <div class="h1">
        <h1>Carrom Opponent Details</h1></div>
<form action="http://localhost/WT/CarromOpp.php" method="post">
...
$q1="select * from carrom where Year ='$year' AND Branch ='$branch'";
