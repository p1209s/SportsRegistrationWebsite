...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    ...
    <div class="h1">
        <h1>Cricket Team Registration</h1></div>
<form action="http://localhost/WT/CricketReg.php" method="post">
<p align="center">
BRANCH:-
<select name="Branch" align="center">
...
for ($i=0; $i <15 ; $i++) 
{ 
$s="insert into cricket(PEN,Name,ContactNumber,Branch,Year) value ('".$_POST['PEN'][$i]."','".$_POST['Name'][$i]."','".$_POST['ContactNumber'][$i]."', '$Branch','$Year')";
