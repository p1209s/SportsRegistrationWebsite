...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    ...
    <div class="h1">
        <h1>Select any Sports to see Rules and Regulation</h1></div>
    <div style="margin-left: 400px; width: 40%";>
      <table class="table table-bordered">
        <tr>
            <td><a class="btn btn-info btn-lg btn-block" href="CricketRule.php" role="button">Cricket</a></td>
            <td><a class="btn btn-info btn-lg btn-block" href="VolleyballRule.php" role="button">Volleyball</a></td>
          </tr>
          <tr>
              <td><a class="btn btn-info btn-lg btn-block" href="CarromRule.php" role="button">Carrom</a></td>
              <td><a class="btn btn-info btn-lg btn-block" href="ChessRule.php" role="button">Chess</a></td>
          </tr>
          <tr>
              <td><a class="btn btn-info btn-lg btn-block" href="KabaddiRule.php" role="button">Kabaddi</a></td>
              <td><a class="btn btn-info btn-lg btn-block" href="TTRule.php" role="button">TableTennis</a></td>
          </tr>
        </table>
        </div>
<!------- Footer ------->
