...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    ...
    <div class="h1">
        <h1>Chess Registration</h1></div>
<form action="http://localhost/WT/ChessReg.php" method="post">
       ...
       <div style="margin-left: 200px; width: 70%;">
        <table class="table table-bordered"> 
            ...
            <tr>
                ...
                <td><input type="number" name="ContactNumber" required="" placeholder="Enter Contact Number"></td>
            </tr>
            </tbody>
        </table>
    </div>
...
if(isset($_POST['submit']))
{
	...
	$sql = "INSERT INTO chess (PEN,Name,ContactNumber,Branch,Year)
     VALUES ('$PEN','$Name','$ContactNumber','$Branch','$Year')";
