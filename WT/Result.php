...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    ...
    <div class="h1">
        <h1 >Select any Sport to See Result</h1></div>
    <div style="margin-left: 400px; width: 40%";>
<table class="table table-bordered">
<tr>
    <td ><a class="btn btn-info btn-lg btn-block" href="ResultCheck.php">Cricket</a></td>
    <td ><a class="btn btn-info btn-lg btn-block"  href="ResultCheck.php">Volleyball</a></td>
    <td ><a class="btn btn-info btn-lg btn-block"  href="ResultCheck.php">Kabaddi</a></td>
</tr>
            </table></div>
<!------- Footer ------->
  <footer id="footer">
