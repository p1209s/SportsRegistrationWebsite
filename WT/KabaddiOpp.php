...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    ...
    <div class="h1">
        <h1>Kabaddi Opponent Details</h1></div>
<form action="http://localhost/WT/KabaddiOpp.php" method="post">
...
$q1="select * from kabaddi where Year ='$year' AND Branch ='$branch'";
