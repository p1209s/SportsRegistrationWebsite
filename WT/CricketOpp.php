...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    ...
    <div class="h1">
        <h1>Cricket Opponent Details</h1></div>
<form action="http://localhost/WT/CricketOpp.php" method="post">
...
$q1="select * from cricket where Year ='$year' AND Branch ='$branch'";
