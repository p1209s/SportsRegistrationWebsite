...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    ...
    <div class="h1">
        <h1>Select any Sport to see Schedule</h1></div>
    <div style="margin-left: 400px; width: 40%";>
<table class="table table-bordered">
<tr>
    <td><a class="btn btn-info btn-lg btn-block" href="CricketSchedule.php" role="button">Cricket</a></td>
    <td><a class="btn btn-info btn-lg btn-block" href="VolleyballSchedule.php" role="button">Volleyball</a></td>
    <td><a class="btn btn-info btn-lg btn-block" href="KabaddiSchedule.php" role="button">Kabaddi</a></td>
</tr>
</table>
    </div>
<!------- Footer ------->
